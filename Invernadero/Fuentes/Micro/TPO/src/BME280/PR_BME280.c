...
#ifndef BME280_PR_BME280_C_
#define BME280_PR_BME280_C_

#include <BME280/PR_BME280.h>
 ...
 * y 3 son de temperatura luego sepepara los valores y compensa
 * las mediciones
 */
...
//    var1 =
//		((((uncomp_temp / 8) - ((int32_t) dev.calib_data.dig_t1 << 1))) * ((int32_t) dev.calib_data.dig_t2)) / 2048;
//
//	var2 =
//		(((((uncomp_temp / 16) - ((int32_t) dev.calib_data.dig_t1)) *
//		   ((uncomp_temp / 16) - ((int32_t) dev.calib_data.dig_t1))) / 4096) * ((int32_t) dev.calib_data.dig_t3)) / 16384;
//
//	dev.calib_data.t_fine = var1 + var2;
//	*comp_temp = (dev.calib_data.t_fine * 5 + 128) / 256;
...
//	var1 =
//		(((dev.calib_data.dig_p3 * (((var1 / 4) * (var1 / 4)) / 8192)) / 8) +
//		 ((((int32_t) dev.calib_data.dig_p2) * var1) / 2)) / 262144;
...
//		}
//		var1 = (((int32_t) dev.calib_data.dig_p9) * ((int32_t) (((*comp_pres / 8) * (*comp_pres / 8)) / 8192))) /
//			   4096;
//		var2 = (((int32_t) (*comp_pres / 4)) * ((int32_t) dev.calib_data.dig_p8)) / 8192;
//		*comp_pres = (uint32_t) ((int32_t) *comp_pres + ((var1 + var2 + dev.calib_data.dig_p7) / 16));
//    }
