...
public:
    ...
    void setupUi(QDialog *Tabla)
    {
        ...
        Tabla->resize(724, 461);
        layoutWidget = new QWidget(Tabla);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(0, 0, 721, 451));
    ...
    {
        Tabla->setWindowTitle(QApplication::translate("Tabla", "Dialog", nullptr));
        ...
        ___qtablewidgetitem4->setText(QApplication::translate("Tabla", "Nivel de riego", nullptr));
        QTableWidgetItem *___qtablewidgetitem5 = tableWidget_Datos->horizontalHeaderItem(5);
        ___qtablewidgetitem5->setText(QApplication::translate("Tabla", "Nivel de luz", nullptr));
